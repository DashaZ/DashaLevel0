...
JOptionPane.showMessageDialog(null, "Piranhas are more "+adjective+" during the day, so cross the river at night.\n Piranhas are attracted to fresh "+liquid+" and will most "
		...
		+ "No matter what you do, you will end up getting bit. My advice to you is try to find another way to get back to the "+place+". Good luck! (^-^)");
JOptionPane.showMessageDialog(null, "You got bit! (Ha! Ha!)	 ");
	}
}